...
<body>
    ...
    <div id="gallery" class="page wb-page">
        ...
        <section id="section-729124" class="
                sec-padding-lg                 ">
            <div class="grid wow slideInDown">



                <ul class="imageListsWidget imgs-gallery ">
                    <li class="js_image_gallary">
                        <figure class="effect-sadie"><img id="image1" class="lazyload    "
                                data-src="//images.pexels.com/photos/1108572/pexels-photo-1108572.jpeg?auto=compress&amp;cs=tinysrgb&amp;h=650&amp;w=940"
                                width="" height="">
                    ...
                    <li class="js_image_gallary">
                        <figure class="effect-sadie"><img id="image2" class="lazyload    "
                                data-src="//images.pexels.com/photos/1192057/pexels-photo-1192057.jpeg?auto=compress&amp;cs=tinysrgb&amp;h=650&amp;w=940"
                                width="" height="">
                            <figcaption class="text-center">
                                <h2>iOS &amp; Android Development</h2>
                            </figcaption>
                        </figure>
                    </li>
                    <li class="js_image_gallary">
                        <figure class="effect-sadie"><img id="image3" class="lazyload    "
                                data-src="//images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&amp;cs=tinysrgb&amp;h=650&amp;w=940"
                                width="" height="">
                            <figcaption class="text-center">
                                <h2>UI/UX Design</h2>
                            </figcaption>
                    ...
                    <li class="js_image_gallary">
                        <figure class="effect-sadie"><img id="image4" class="lazyload    "
                                data-src="//images.pexels.com/photos/2004161/pexels-photo-2004161.jpeg?auto=compress&amp;cs=tinysrgb&amp;h=650&amp;w=940"
                                width="" height="">
                            <figcaption class="text-center">
                    ...
                    <li class="js_image_gallary">
                        <figure class="effect-sadie"><img id="image5" class="lazyload    "
                                data-src="//images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&amp;cs=tinysrgb&amp;h=650&amp;w=940"
                                width="" height="">
                            <figcaption class="text-center">
                    ...
                    <li class="js_image_gallary">
                        <figure class="effect-sadie"><img id="image6" class="lazyload    "
                                data-src="//images.pexels.com/photos/256381/pexels-photo-256381.jpeg?auto=compress&amp;cs=tinysrgb&amp;h=650&amp;w=940"
                                width="" height="">
                            <figcaption class="text-center">
                                <h2>App Testing &amp; Quality Assurance</h2>
                            </figcaption>
                        </figure>
                    </li>
                </ul>
